...
<body>
    ...
    <% Integer [] investment_stock = {10, 15, 20, 25, 30, 35}; %>
    <% Integer [] investment_target = {110000, 120000, 130000, 140000, 150000, 160000}; %>

    <% String [] email = {  "cs@traveloka.com",
                            "care@tokopedia.com",
                            "btpncare@btpn.com",
                            "help@dana.id",
                            "hello@haus.co.id",
    ...
    <% String [] description = {   "Traveloka merupakan startup yang memberikan layanan lengkap meliputi pemesanan tiket pesawat, booking hotel secara daring dan layanan lainnya yang terkait perjalanan dan akomodasi. Startup ini didirikan pada tahun 2012 dan sudah beroperasi secara aktif di hampir semua wilayah di Indonesia.",
    ...
    <% String [] shortDescription = {   "Solution for your lifestyle needs from flight, hotel, train, and more.",
